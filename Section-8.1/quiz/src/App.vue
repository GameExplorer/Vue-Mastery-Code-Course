...
<div class="ctr">
  <Transition name="fade" mode="out-in">
    ...
    :questions="questions" :questionsAnswered="questionsAnswered" @question-answered="questionAnswered"/> <!-- v-if checks if we answered questions, we pass down the question array -->
    
    <Results v-else :results="results" :totalCorrect="totalCorrect" /> <!-- if we answered the question show the results -->
  </Transition>
  <button type="button" class="reset-btn" @click.prevent="reset"
  v-if="questionsAnswered === questions.length">Reset</button> <!-- reset button -->
</div>
</template>
