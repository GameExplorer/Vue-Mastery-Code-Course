...
export default {
  name: 'CompositionItem', // define the name of the component
  props: {
    // define props
    song: {
      type: Object, // this prop is an object
      required: true // this is a required prop
      },
      updateSong: {
          type: Function,
        required: true,
  ...
  methods: {
      async edit(values) {
          ...
          this.alert_message = 'Song info updated!';
      //console.log('Submit')
      },
      async deleteSong() {
